            ...
            <ul :class="(toggleMenu) ? 'navbar__navbar-list show' : 'navbar__navbar-list'">
                ...
                <li class="nav-dropdown" @click="toggleDropdown = !toggleDropdown">
                    <div class="nav-dropdown-link">
                        <span>Boxes</span>
                        <svg width="8" height="7" viewBox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 1L9 9L17 1" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <ul :class="(toggleDropdown) ? 'navbar-dropdown show font-gobold' : 'navbar-dropdown font-gobold'">
