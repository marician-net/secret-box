<template>
  <div class="box">
              ...
              <h6 @click="subListMenuActive(submenu.id)">
                ...
                <ul class="list-menu"  v-if="submenu.sub">
                  <li v-for="submenu1 in submenu.sub" :key="submenu1.id" :class="(menuActive.includes(submenu.id))? 'sub-list-menu active' : 'sub-list-menu'">
                    <h6>
                      <router-link :to="submenu1.link"> <s-icon :name="submenu1.icon" /> {{ submenu1.name }} </router-link>
                    </h6>
                  </li>
                </ul>
            </li>
    ...
    <div :class="($route.path == '/docs') ? 'content-wrapper full-width' : 'content-wrapper'">
        ...
        <br>
        <p>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magnam id voluptate beatae natus, culpa voluptatum quo consectetur sed autem amet in voluptates rerum reprehenderit. Minus voluptatem in mollitia voluptas dolore.
        </p>
        <br>
      ...
      <ul class="list-menu-wrapper-right" v-if="$route.path !== '/docs'">
        <li @click="scrollToElement('solution1')">
          Solution 1
        </li>
         <li @click="scrollToElement('solution2')">
          Solution 2
        </li>
          <li @click="scrollToElement('common-error')">
          Common Error
        </li>
        <li @click="scrollToElement('error-table')">
          Error Table
        </li>
      </ul>
  </div>
